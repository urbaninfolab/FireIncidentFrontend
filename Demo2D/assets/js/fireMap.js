    ...
    async function mapFireIncident(map, dateArray, inactive_flag, shapefile_display_flag, purple_air_diaplay_flag, microsoft_air_display_flag) {
        ...
        for (let i = 0; i < dateArray.length; i++) {
            try{
                ...
                let jsonUrl = 'https://firesync.uturbaninfolab.workers.dev/data/' + date + '-FireMap' + cities[city] + '.json';
                if(date == "2022-08-08")
                    jsonUrl = 'https://firesync.uturbaninfolab.workers.dev/data/' + date + '-FireMap' + cities[city] + '.json';
